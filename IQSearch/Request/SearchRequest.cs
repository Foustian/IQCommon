...
{
    [Serializable]
    public class SearchTVRequest : IEquatable<SearchTVRequest>
    {
        ...
        /// <summary>
        /// Comma-separated list of station ids to exlude for
        /// </summary>
        public List<string> ExcludeStations
        {
            get { return _excludeStationIds; }
            set { _excludeStationIds = value; }
        } List<string> _excludeStationIds = null;
        ...
        /// <summary>
        /// Comma-separated list of DMA Names to exclude
        /// </summary>
        public List<string> ExcludeIQDmaName
        {
            get { return _Exclude_IQ_Dma_Name; }
            set { _Exclude_IQ_Dma_Name = value; }
        }List<string> _Exclude_IQ_Dma_Name;
        ...
        public Boolean GenerateQuarterHour
        {
            get { return _GenerateQuarterHour; }
            set { _GenerateQuarterHour = value; }
        }bool _GenerateQuarterHour = false;

        public long? LastSequenceId
        {
            get { return _LastSequenceId; }
            set { _LastSequenceId = value; }
        }long? _LastSequenceId = null;

        public bool Equals(SearchTVRequest other)
        {
